...
// Mock 数据
const mockNewsListData: NewsListResponse = {
  code: 200,
  message: '成功获取新闻列表',
  data: {
    pagination: {
...
const mockNewsDetailData: NewsDetailResponse = {
  code: 200,
  message: '成功获取文章详情',
  data: {
    article_id: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
